...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de los mensajes por defecto del validador de
    | Laravel. Los formularios propios de la aplicación pueden sobrescribir
    | mensajes puntuales en su clase FormRequest; estos son el respaldo
    | para cualquier regla que no tenga un mensaje personalizado.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor indicado para :attribute ha aparecido en una filtración de datos. Elija un :attribute diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplazan el marcador :attribute por un nombre de campo legible, en
    | los formularios de toda la aplicación.
    |
    */
    ...
    'attributes' => [
        ...
        'telefono' => 'teléfono',
        'ciudad' => 'ciudad',
        'situacion_id' => 'situación laboral',
        'rubro_id' => 'rubro',
        'empresa' => 'empresa',
        'cargo' => 'cargo',
        'fecha_inicio' => 'fecha de inicio',
        'fecha_fin' => 'fecha de fin',
        'perfil_visible' => 'visibilidad del perfil',
        'titulo' => 'título',
